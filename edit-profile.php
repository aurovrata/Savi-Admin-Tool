 ...
 */
class Edit_Profile_List_Table extends WP_List_Table {
    ...
    function get_columns(){
		 ...
		 */
		$columns = apply_filters( 'wpmu_blogs_columns', $columns );
...
$args = array(
 ...
 add_screen_option( 'per_page', $args );
     ...
     // $screen->render_screen_meta();
      // echo $per_page = $this->get_items_per_page( 'pippin_per_page' );
       ...
       // echo "<pre>",print_r($custom_List_records),"</pre>";        
        //$data = $this->example_data;
          $data = $custom_List_records;      
 ...
 */
    function tt_add_menu_items1(){
        global $pippin_sample_page;  
        $pippin_sample_page = add_menu_page('Example Plugin List Table', 'Edit Profile', 'activate_plugins', 'tt_list_test1', 'tt_render_list_page1');
        add_action("load-$pippin_sample_page", "pippin_sample_screen_options1");
    } 
    function pippin_sample_screen_options1() {
       global $pippin_sample_page;
       $screen = get_current_screen();
   ...
   function pippin_set_screen_option1($status, $option, $value) {
	if ( 'pippin_per_page' == $option ) return $value;
   }
  
   add_action('admin_menu', 'tt_add_menu_items1');
   add_filter('set-screen-option', 'pippin_set_screen_option1', 10, 3);
   add_filter('manage_toplevel_page_tt_list_test1_columns','custom_facebook_features1');

function custom_facebook_features1( ) {
 $columns = array(
            'cb'        => '<input type="checkbox" />', //Render a checkbox instead of text
            'title'     => 'Title',
            'rating'    => 'Rating',
 ...
 */
function tt_render_list_page1(){
    
    //Create an instance of our package class...
    $testListTable1 = new Edit_Profile_List_Table();
    //Fetch, prepare, sort, and filter our data...
    $testListTable1->prepare_items();
